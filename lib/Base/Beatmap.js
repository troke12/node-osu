 ...
 * @prop {Number} hasVideo
 * @prop {Number} hasDownload
 * @prop {Number} hasAudio
...
class Beatmap {
	constructor(config, data) {
		...
		this.hasVideo = num(data.video);
		this.hasDownload = num(data.download_unavailable);
		this.hasAudio = num(data.audio_unavailable);
	}
